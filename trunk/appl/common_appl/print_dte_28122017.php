...
//echo (dirname(__FILE__)."TCPDF-master/tcpdf.php");
...
switch ($DTE_ORIGEN) {
	...
	$pdf->Text(149, 15,'R.U.T.: 80.112.900-5');
	...
	$pdf->Text(10, 35,'BIGGI CHILE SOCIEDAD LIMITADA');
	$pdf->SetFont('helvetica','',6.25);
	$pdf->Text(10, 40,'FABRICACION DE ARTEFACTOS PARA LA MANIPULACION, COCCION Y TRANSPORTE DE ALIMENTOS');
	...
	for($z=0; $z<4; $z++) {
		...
		$pdf->SetTextColor(255,0,0);
		$pdf->SetFont('helvetica','B',12.25);	
		$pdf->Text(149, 15-7,'R.U.T.: 80.112.900-5');
		...
		$pdf->SetTextColor(0,0,0);
		$pdf->Text(10, 35-7,'BIGGI CHILE SOCIEDAD LIMITADA');
		$pdf->SetFont('helvetica','',6.25);
		$pdf->Text(10, 40-7,'FABRICACION DE ARTEFACTOS PARA LA MANIPULACION, COCCION Y TRANSPORTE DE ALIMENTOS');
