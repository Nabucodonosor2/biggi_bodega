...
class wi_factura extends wi_factura_base {
	...
	function enviar_dte(){
		...
		if ($FolioRef <> ''){
			...
			$c['Referencia']['TpoDocRef']	= $TpoDocRef; //D(descuento) o R(recargo)
			$c['Referencia']['FolioRef']	= $FolioRef;//Indica si es Porcentaje o Monto “%” o “$”
	...
	function xml_dte(){
		...
		$name_archivo = "33_$nro_factura.xml";
