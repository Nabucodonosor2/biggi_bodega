...
class wo_factura extends wo_factura_base {
	...
	function redraw_item(&$temp, $ind, $record){
		...
		if($COD_ESTADO_DOC_SII == 3 && $this->autoriza_xml == true && $COD_FACTURA > 12833)
...
/* 					$sql = "SELECT DISTINCT COD_FACTURA
					...
					//MH COMENTA LAS LINEAS ANTERIORES AL PARECER FUERON MAL COPIADAS DESDE ORTRO CODIGO DESDE AHORA MUESTRA LAS FA ASOCIADAS CORRECTAS	
					$sql = "SELECT NRO_FACTURA FROM FACTURA WHERE NRO_ORDEN_COMPRA = '$cod_orden_compra'"; 	
