...
class wi_guia_despacho extends w_input {
	...
	function new_record() {
		...
		$sql = "SELECT NOM_TIPO_GD_INTERNO_SII
				...
				WHERE TGD.COD_TIPO_GUIA_DESPACHO = ".self::K_TIPO_GUIA_DESPACHO_TRASLADO."
	...
	function imprimir_dte($desde_output=false){
		...
		if($guia_despacho > 255)
			...
			if(file_exists("../../../../PDF/PDFBIGGICHILE/$year/52_$nro_guia_despacho.pdf"))
				print " <script>window.open('../../../../PDF/PDFBIGGICHILE/$year/52_$nro_guia_despacho.pdf')</script>";
			else
