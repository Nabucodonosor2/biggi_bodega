...
class wo_producto_bodega_base extends w_output_biggi{
	function wo_producto_bodega_base(){
...
$file_name = dirname(__FILE__)."/".K_CLIENTE."/class_wo_producto_bodega.php";
if (file_exists($file_name)) 
	require_once($file_name);
else {
	class wo_producto_bodega extends wo_producto_bodega_base{
		function wo_producto_bodega(){
			parent::wo_producto_bodega_base(); 
		}
	}
}
?>