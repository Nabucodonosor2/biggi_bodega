...
class wo_inf_bodega_por_recibir extends w_informe_pantalla {
   ...
   function wo_inf_bodega_por_recibir() {
		...
		$this->add_header(new header_num('CANT_SOLICITADA', 'CANT_SOLICITADA', 'CT Solicitada'));
		$this->add_header(new header_num('CANT_RECIBIDA', 'CANT_RECIBIDA', 'CT Recibida'));
		$this->add_header(new header_num('CANT_POR_RECIBIR', 'CANT_POR_RECIBIR', 'CT X Recibir'));
		$this->add_header(new header_num('PRECIO_COMPRA', 'PRECIO_COMPRA', 'Costo $'));
