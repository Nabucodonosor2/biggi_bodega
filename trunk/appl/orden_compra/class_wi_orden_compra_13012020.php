...
class dw_orden_compra extends dw_help_empresa {
	...
	function dw_orden_compra() {	
		...
		$this->add_control($control = new edit_check_box('RESPETA_PRECIO', 'S', 'N'));
...
class wi_orden_compra_base extends w_cot_nv {
	...
	function save_record($db) {	
		...
		$respeta_precio = $this->dws['dw_orden_compra']->get_item(0, 'RESPETA_PRECIO');
	    ...
	    $ES_OC_MANUAL = ($ES_OC_MANUAL=='') ? "null" : "'$ES_OC_MANUAL'";
