...
function change_empresa(ve_cod_empresa) {
	var vl_precio_compra = ve_cod_empresa.options[ve_cod_empresa.selectedIndex].label;
...
function detalle_stock(ve_control){
	...
	if(vl_cod_empresa != '' && vl_cod_empresa == 4){
		...
		window.showModalDialog("dlg_detalle_stock.php?cod_producto="+vl_cod_producto+"&cod_empresa="+vl_cod_empresa+"&cantidad_total="+vl_cantidad_total, "_blank", args);
	}
}