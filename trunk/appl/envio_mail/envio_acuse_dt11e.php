...
for($i=0; $i < count($result); $i++) {
	...
	if($tipodte == 33 || $tipodte == 34){
		...
		$result[$i]['MAIL_BODY'] = $this->arma_body($NOM_EMPRESA_DETINATARIO,$nom_tipo_documento,$fecha_documento,$monto,$pie_pagina);
		...
		$result[$i]['MAIL_BODY'] = arma_body($NOM_EMPRESA_DETINATARIO,$nom_tipo_documento,$fecha_documento,$monto,$pie_pagina);
...
function arma_body($NOM_EMPRESA_DETINATARIO,$nom_tipo_documento,$fecha_documento,$monto,$pie_pagina){
