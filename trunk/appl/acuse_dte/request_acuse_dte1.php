...
//echo 11111;
//return;
//http://www.biggi.cl/sysbiggi_new/bodega_biggi/biggi/trunk/appl/acuse_dte/request_acuse_dte.php?NRO_DOC=171168&TIPO_DOCUMENTO=33&DESTINATARIO={Email intercambio : comercial_dte@integrasystem.cl}&RUT_EMISOR=80112900&TRIGGER=prueba
...
//$DESTINATARIO = $DESTINATARIO_ARRAY;
...
$mail->Timeout=30;
$mail->Subject = "EnvioDTE: $rut - $nom_tipo_documento N° $nro_doc ..ORIGINALMENTE PARA $DESTINATARIO";//Ej: EnvioDTE: 80.112.900-5 - Factura electrónica N° 171115
