...
$param = "
		...
		,null
	 	...
	 	,null
	 	,null
	 	,'mherrera@biggi.cl;vmelo@integrasystem.cl;evergara@integrasystem.cl;ecastillo@integrasystem.cl'
	 	,'Marcelo Herrera;Victor Melo;Erick Vergara;Eduardo Castillo'
	 	,'$mail_para'
	 	,null
	 	,'$asunto'
	 	,'".str_replace("'","''",$body)."'
