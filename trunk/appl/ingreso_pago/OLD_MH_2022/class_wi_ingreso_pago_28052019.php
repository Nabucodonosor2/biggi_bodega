...
class wi_ingreso_pago_base extends w_input {
	...
	function navegacion(&$temp){
		...
		if($cod_estado_ingreso_pago == 2 && 
				($this->cod_usuario == 1 
				or $this->cod_usuario == 6 
				or $this->cod_usuario == 7 
				or $this->cod_usuario == 12 
				or $this->cod_usuario == 15)){
	...
	function envio_mail(){
		...
		$lista_mail_to		= "'sergio.pechoante@biggi.cl'";
		$lista_mail_to_name	= "'Sergio Pechoante'";

		$lista_mail_cc		= "'psilva@biggi.cl;fpuebla@biggi.cl;ascianca@biggi.cl'";
		$lista_mail_cc_name	= "'Piero Silva;Felipe Puebla;Angel Scianca'";
